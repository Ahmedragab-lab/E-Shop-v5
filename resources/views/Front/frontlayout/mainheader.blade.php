				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+2)01021493036" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+2)01021493036</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assetsfront/images/logo-top-1.png') }}" alt="mercado"></a>
						</div>
						...
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								<li class="menu-item home-icon">
									<a href="{{ route('fronts.index') }}" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a>
								</li>
								<li class="menu-item">
								...
								<li class="menu-item">
									<a href="{{ route('mycart.index') }}" class="link-term mercado-item-title">My Cart</a>
								</li>
								<li class="menu-item">
