                ...
                <div class="wrap-product-detail">
                        ...
                        <div class="product-gallery">
                          <ul class="slides">
                            ...
                            <li data-thumb="{{ asset('uploads/product/' . $product->image) }}">
                                <img src="{{ asset('uploads/product/' . $product->image) }}" alt="product thumbnail" />
                            </li>
                    ...
                    <div class="detail-info">
                        ...
                        <div class="short-desc">
                            <ul>
                                <li>{{ $product->small_desc}}</li>
                                <li>{{ $product->desc }}</li>
                                {{-- <li>FaceTime HD Camera 7.0 MP Photos</li> --}}
                            </ul>
                        </div>
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{ asset('uploads/product/' . $product->image) }}" alt=""></a>
                        </div>
